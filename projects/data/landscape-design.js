...
window.PROJECTS['landscape-design'] = {
  title: '景观设计',
  date: 'Sept 2022 – Mar 2024',
  summary: '在此整理了部分学生时代的一些景观竞赛图纸与个人作品。',
  sections: [
    {
      title: '涟漪效应——多功能复合的社区韧性花园设计',
      level: 2,
      content: [
    ...
    {
      title: '共·呼吸——基于后疫情时期背景下的居住区健康绿化设计',
      level: 2,
      content: [
